...
from .yaml_utils import expand_env_vars, load_config, merge_config, merge_dict

class YAMLConfig(BaseConfig):
    def __init__(self, cfg_path: str, **kwargs) -> None:
        super().__init__()

        default_datasets_root = Path(cfg_path).resolve().parents[2] / "datasets"
        os.environ.setdefault("WHEAT_DATASETS_ROOT", str(default_datasets_root))
